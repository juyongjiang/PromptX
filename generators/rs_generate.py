    ...
    def func_impl(
        ...
        if strategy == "mcts":
            return generate_with_accumulated_context(
                ...
                reflection_chat_instruction=RS_REFLEXION_CHAT_INSTRUCTION,
                simple_chat_instruction=RS_SIMPLE_CHAT_INSTRUCTION,
                reflection_completion_instruction=RS_REFLEXION_COMPLETION_INSTRUCTION,
                simple_completion_instruction=RS_SIMPLE_COMPLETION_INSTRUCTION,
                code_block_instruction = USE_RUST_CODEBLOCK_INSTRUCTION,
                reflection_few_shot=RS_REFLEXION_FEW_SHOT_ADD,
